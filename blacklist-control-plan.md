...
> ** Note: **
>
> All the following operations need the `super privilege` privilege of the database. Each optimization rule has a name. e.g. the name of column pruning is `column_prune`. The names of all optimization rules can be found in the second column of the table [Important Optimizati
    ...
    ```on Rules](#Important_Optimization_Rules).
